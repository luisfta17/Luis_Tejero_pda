...
// The calculator displays 'inifinity'
// Function has been modify to display 'Error try again' instead of 'inifinity'
...
it('should update the display to show an error message when you use the divide operator to divide by zero', function () {
   ...
   element(by.css('#number0')).click();
   element(by.css('#operator_equals')).click();
   expect(running_total.getAttribute('value')).to.eventually.equal('Error try again');
});
